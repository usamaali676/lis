                ...
                <tbody>
                   ...
                   <tr>
                    ...
                    @else
                        No
                    @endif</td>
                    <td><a href="{{route('blog.edit')}}/{{ $item->id}}" class="button">Edit</a>
                    <a href="{{route('business.single')}}/{{ $item->slug}}" class="button">View</a>
                    <a onclick="return confirm('Are you sure you want to delete this item')"  href="{{route('blog.delete')}}/{{ $item->id}}" class="button">Delete</a></td>
                </tr>
                   @endforeach
