    ...
    <div id="titlebar">
        <div class="row">
            <div class="col-md-12">
                ...
                <!-- Breadcrumbs -->
                <nav id="breadcrumbs">
                    <a href="{{route('state.add')}}" class="button">Add State</a>
                </nav>
            </div>
        </div>
    </div>
                ...
                <table id="example" class="table table-striped table-bordered" style="width:100%">
                    ...
                    <tbody>
                       ...
                       <tr>
                        ...
                        <td><a href="{{route('state.edit')}}/{{ $item->id}}" class="button">Edit</a> <a onclick="return confirm('Are you sure you want to delete this item')"  href="{{route('state.delete')}}/{{ $item->id}}" class="button">Delete</a></td>
                    </tr>
                       @endforeach
