        ...
        <div id="titlebar">
            <div class="row">
                <div class="col-md-12">
                    <h2>Users</h2>
                    <!-- Breadcrumbs -->
                    <nav id="breadcrumbs" style="margin: auto;">
                        <a href="{{route('user.add')}}" class="button">Add User</a>
                    </nav>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <table id="example" class="table table-bordered table-hover dt-responsive">
                    ...
                    <tr>
                        ...
                        <td><a href="{{route('user.edit')}}/{{ $item->id}}" class="button">Edit</a> <a onclick="return confirm('Are you sure you want to delete this item')"  href="{{route('user.delete')}}/{{ $item->id}}" class="button">Delete</a></td>
                    </tr>
